...
import MyScore from '../PokerTable/MyScore'
import Rules from '../PokerTable/Rules'
import Hamilton from '../Cards/Hamilton'
import Burr from '../Cards/Burr'
import Jefferson from '../Cards/Jefferson'
import Pocket from '../Cards/Pocket'
import FeltTable from './FeltTable'
import CashMeter from './CashMeter'
import {cipher} from '../Math/CountingCards'
import Marquee from '../PokerTable/Marquee'
...
const Game = (props) => {
    ...
    const clear = () => {
        ...
        console.log(poker.bigPosition, 'bg-index')
        console.log(refreshBg, 'big-updated')
                        ...
                        <div className='pocket-divider' >
                            ...
                            
                            {
                                toggleBigBlind === 3 
                                    ...
                                    ? <div className='button-container' > <Smally  /> </div>
                                    : toggleButton === 3 
                                    ? <div className='button-container' > <p style={{fontweight: 'bold'}} > Dealer </p> </div>
                                    : <div className='button-container' > </div>                          
                            }
                        </div>
                    </div>
